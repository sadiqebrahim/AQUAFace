...
configurations = {
    1: dict(
        ...
        DATA_ROOT = '/workspace/codes/CurricularFace/', # the parent root where your train/val/test data are stored
        RECORD_DIR = '/data2/yugehuang/data/refined_ms1m.txt', # the dataset record dir
        MODEL_ROOT = '/workspace/codes/CurricularFace/', # the root to buffer your checkpoints
        LOG_ROOT = './train_log/log', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = "/workspace/codes/CurricularFace/CurricularFace_Backbone.pth",
        HEAD_RESUME_ROOT = "",
